...
- [Analytics — Recent Events](analytics/reports/events.md)
- [Analytics — Heatmaps](analytics/reports/heatmaps.md)
- [Analytics — Payments](analytics/reports/payments.md)
- [Analytics — Vehicles](analytics/reports/vehicles.md)
...
- [Dashboard Home](dashboard/home/overview.md)

## features

- [Navigation](features/navigation/overview.md)
- [Tables & Filters](features/tables-and-filters/overview.md)
- [AI Chat](features/ux/ai-chat.md)
- [Notifications](features/ux/notifications.md)
- [Themes](features/ux/themes.md)
...
- [Client Detail](operations/customers/client-detail.md)
- [Clients — List](operations/customers/clients.md)
...
- [Ride Detail](operations/trips/ride-detail.md)
- [Rides — List](operations/trips/rides.md)
...
- [Conversations](support/tickets-proofs-chat/conversations.md)
