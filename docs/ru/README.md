...
- [Аналитика — Recent Events](analytics/reports/events.md)
- [Аналитика — Heatmaps](analytics/reports/heatmaps.md)
- [Аналитика — Платежи](analytics/reports/payments.md)
- [Аналитика — Транспорт](analytics/reports/vehicles.md)
...
- [Главная дашборда](dashboard/home/overview.md)

## features

- [Навигация](features/navigation/overview.md)
- [Таблицы и фильтры](features/tables-and-filters/overview.md)
- [AI Chat](features/ux/ai-chat.md)
- [Уведомления](features/ux/notifications.md)
- [Темы](features/ux/themes.md)
...
- [Деталь клиента](operations/customers/client-detail.md)
- [Клиенты — Список](operations/customers/clients.md)
...
- [Rebalance — Runs](operations/rebalance/runs.md)
- [Деталь поездки](operations/trips/ride-detail.md)
- [Поездки — Список](operations/trips/rides.md)
...
- [Чаты](support/tickets-proofs-chat/conversations.md)
- [Park Proof Auto Review](support/tickets-proofs-chat/park-proof-auto-review.md)
